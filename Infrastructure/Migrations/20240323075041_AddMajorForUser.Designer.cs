...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240323075041_AddMajorForUser")]
    partial class AddMajorForUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Infrastructure.Model.Work.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Infrastructure.Model.Work.Faculty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Infrastructure.Model.Work.Major", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Infrastructure.Model.ApplicationUser", b =>
                {
                    ...
                    b.HasOne("Infrastructure.Model.Work.Major", "Major")
                        .WithMany()
            ...
            modelBuilder.Entity("Infrastructure.Model.Work.Faculty", b =>
                {
                    b.HasOne("Infrastructure.Model.Work.Department", "Department")
                        .WithMany()
            ...
            modelBuilder.Entity("Infrastructure.Model.Work.Major", b =>
                {
                    b.HasOne("Infrastructure.Model.Work.Faculty", "Faculty")
                        .WithMany()
